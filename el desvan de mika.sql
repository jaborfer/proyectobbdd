...
CREATE TABLE IF NOT EXISTS `elDesvanDeMika`.`COMPONENTE` (
  ...
  `Cantidad` TINYINT(4) NOT NULL,
  PRIMARY KEY (`Nombre`, `MANUALIDAD_Nombre`),
  INDEX `fk_COMPONENTE_MANUALIDAD1_idx` (`MANUALIDAD_Nombre` ASC),
  CONSTRAINT `fk_COMPONENTE_MANUALIDAD1`
    FOREIGN KEY (`MANUALIDAD_Nombre`)
    REFERENCES `elDesvanDeMika`.`MANUALIDAD` (`Nombre`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `elDesvanDeMika`.`FORMADO` (
  ...
  `cantidad` TINYINT(4) NOT NULL,
  PRIMARY KEY (`MATERIAL_Nombre`, `MATERIAL_Color`, `MATERIAL_Subcolor`, `COMPONENTE_Nombre`, `COMPONENTE_MANUALIDAD_Nombre`),
  INDEX `fk_MATERIAL_has_COMPONENTE_COMPONENTE1_idx` (`COMPONENTE_Nombre` ASC, `COMPONENTE_MANUALIDAD_Nombre` ASC),
  ...
  CONSTRAINT `fk_MATERIAL_has_COMPONENTE_COMPONENTE1`
    FOREIGN KEY (`COMPONENTE_Nombre` , `COMPONENTE_MANUALIDAD_Nombre`)
    REFERENCES `elDesvanDeMika`.`COMPONENTE` (`Nombre` , `MANUALIDAD_Nombre`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
